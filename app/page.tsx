      ...
      <div className="relative z-10 flex flex-col items-center px-4 py-8 max-w-md mx-auto">
        ...
        <div className="w-full space-y-4">
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.98 }}
            onHoverStart={() => setActiveCard("whatsapp")}
            onHoverEnd={() => setActiveCard(null)}
          ...
          >
            ...
            <motion.div
              ...
              animate={activeCard === "whatsapp" ? { borderColor: ["#22c55e", "#16a34a", "#22c55e"] } : {}}
              transition={{ duration: 1, repeat: Number.POSITIVE_INFINITY }}
            />
      ...
      <AnimatePresence>
        <div className="fixed bottom-6 right-6 flex flex-col gap-4 z-50">
          ...
          <motion.a
            ...
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.9 }}
            className="relative w-14 h-14 bg-[#22c55e] rounded-full flex items-center justify-center shadow-lg shadow-[#22c55e]/30"
          >
            <motion.div
